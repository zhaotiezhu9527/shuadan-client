export default { 
  ...
  home: "homepage", balance: "my total assets", 
  rmb: "$", 
  rmb_icon: "$", 
  recharge: "recharge", 
  deposit: "withdraw", 
  ...
  cooperation: "agency cooperation", 
  qualification: "company qualifications", 
  ...
  oredr_submit: "order submit", 
  nodata: "no data yet", 
  all: "all", 
  loading: "pending", 
  success: "completed", 
  error: "freezing", 
  residue_balance: "remaining available assets", 
  ...
  unit: "order", unlocking: "unlock", 
  next: "next level exclusive channel to get higher commissions", 
  order_tips: "order tips", user: "Hello dear user", 
  ...
  reputation: "After grabbing the task order, please submit the order in time to avoid the card order being stuck for a long time and reducing the credit score.", 
  ...
  account_balance: "account amount", loginout: "are you sure to quit?？", 
  renturn_login: "log out", 
  notice: "announcement", 
  sys_notice: "system notice", 
  userset: "personal information", 
  centre: "personal center", 
  creditValue: "credit score", 
  inviteCode: "invitation code", 
  copy: "copy", 
  order_log: "order grabbing record", 
  account_log: "account details", 
  recharge_log: "recharge record", 
