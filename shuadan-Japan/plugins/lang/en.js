export default {
  ...
  accountEmpty: "Please enter your login account~",
  ...
  accountOpening: "“Account opening agreement”",
  termsContract: "Read the terms",
  haveAccount: "Already have an account，Log in now",
  accountLength: "Please enter the account number and the length is greater than 6~",
  ...
  referralCodeLength: "Please enter the 6-digit referral code~",
  myAssets: "Total assets",
  currency: "元", //对应币种 Dollar  $
  ...
  payPasswordManagement: "Transaction password management",
  ...
  totalTeamWithdraw: "Total team withdrawal amount",
  teamOrderCommission: "Team order commission",
  pushNo: "Number of direct referrals",
  ...
  vipLevel: "VIP Level",
  quxiao: "Cancel",
  userYesterday: "Yesterday's earnings",
  userNameNo: "Account",
  teamTime: "Time",
  ...
  withdrawalNetwork: "Cash withdrawal network",
