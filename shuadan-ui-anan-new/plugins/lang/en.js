export default {
  ...
  reputation: "After grabbing the task order, please submit the order in time to avoid the card order being stuck for a long time and reducing the Credit value.",
